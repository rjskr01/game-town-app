...
const TournamentHeader: React.FC = () => {
    ...
    return (
        <div id="dynamicHolder" className="">
            ...
            <div id="dynamicHeader" className={`bg-white text-[black] text-[30px] w-[90%] text-center h-[37px] leading-[37px] font-['Boulder-Regular'] font-boulder ${showTextOne ? 'fade-in' : 'fade-out'}`}>
